...
const failedMissions = (props) => {
    return (
        <div className="flex flex-col w-[48%] mx-[1%] mt-5 border-4 border-red-400 rounded-md">
            <h2 className="text-xs text-center text-white bg-red-400 xl:text-2xl mb-5 py-5 font-semibold">
                Failed Missions
            </h2>
            ...
            {props.failedList.map((miss, i) => {
                ...
                >
                    ...
                    <span className="text-xs xl:text-lg font-semibold text-red-600">
